        ...
        <?php elseif ($userDetails->idrol == 1) : ?>
                                        ...
                                        <?php foreach ($this->model->Listar() as $r) : ?>
                                            <?php if ($r->statusid < 6) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($r->statusid == 5) : ?>
                                                            <a class="btn btn-outline-info radius-15" href="?c=Notify&a=Index&trackingid=<?php echo $r->trackingid; ?>">Notificar</a>
                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h4><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box2" aria-expanded="true" aria-controls="updates-box2">Detalle de paquetes entregados</a></h4><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box"><i class="fa fa-angle-down"></i></a>
                        </div>

                        <div class="card-body collapse hide" id="updates-box2" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                        ...
                                        <?php foreach ($this->model->Listar() as $r) : ?>
                                            <?php if ($r->statusid == 6) : ?>
                                                <tr>
                                                    ...
                                                    <td><i class="glyphicon glyphicon-edit"><a class="<?php echo $r->statuscode; ?>" href="?c=Trackings&a=Status&trackingid=<?php echo $r->trackingid; ?>"><?php echo $r->statusname; ?></a></i></td>
                                                    <td>
                                                        <?php $newDate = date("d/m/Y", strtotime($r->deliverydate));
                                                        echo $newDate; ?>
                                                    </td>
