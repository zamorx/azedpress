									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="ms-2">
													<h6 class="mb-0 font-14"><?php echo $r->name; ?></h6>
												</div>
											</div>
										</td>
										<td>AZ<?php echo $r->trackingid; ?></td>
										<td><div class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3"><i class="bx bxs-circle me-1"></i><?php echo $r->statusname; ?></div></td>
										<td><?php echo $r->servicename; ?></td>
										<td><?php $newDate = date("d/m/Y", strtotime($r->estdate));
                                                        echo $newDate; ?></td>
										<td><button type="button" class="btn btn-primary btn-sm radius-30 px-4">Factura</button></td>
										<td>
